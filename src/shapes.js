...
export function drawShoeWithGradient(ctx, slider) {
...
export function drawWaistWithGradient(ctx, slider) {
...
export function drawPersonWithGradient(ctx, slider, options = {}) {
